...
export default function Navbar() {
  ...
  return (
    <nav
      className={cn(
        'h-20 z-10 border boerder-b-gray-20 w-full shadow-sm p-4 sm:px-10 flex justify-between items-center align-middle fixed top-0 bg-white',
        {
    ...
    >
      ...
      {showFilter === false ? (
        ...
        <div className="sm:w-[340px] cursor-pointer w-full relative">
          <div className="flex justify-center gap-7 h-14 text-center items-center">
            <button
              type="button"
              className="font-semibold underline underline-8"
            >
              숙소
            </button>
            <button
            ...
            <button
              type="button"
              className="underline underline-8  text-gray-500 hover:text-black "
              onClick={() => setShowFilter(false)}
            >
              필터 닫기
            </button>
          </div>
          <div className="w-[90%] sm:max-w-3xl flex flex-col sm:flex-row border border-gray-200 rounded-1g py-4 sm:py-0 sm:rounded-full shadow-sm bg-white hover:shadow-lg cursor-pointer justify-between fixed top-20 inset-x-0 mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-4 w-full relative sm:pl-2">
              <button
                ...
                className={cn(
                  ...
                  { 'shadow bg-while': detailFilter === 'location' },
                )}
              >
                여행지
              ...
              <button
                ...
                className={cn(
                  'font-semibold text-xs rounded-full hover:bg-gray-100 py-3 px-6 text-left',
                  { 'shadow bg-while': detailFilter === 'checkIn' },
                )}
              >
                체크인
                <div className="text-gray-500 text-xs mt-1">
              ...
              <button
                ...
                className={cn(
                  'font-semibold text-xs rounded-full hover:bg-gray-100 py-3 px-6 text-left',
                  { 'shadow bg-while': detailFilter === 'checkOut' },
                )}
              >
                체크아웃
                <div className="text-gray-500 text-xs mt-1">
              ...
              <button
                ...
                className={cn(
                  'font-semibold text-xs rounded-full hover:bg-gray-100 py-3 px-6 text-left',
                  { 'shadow bg-while': detailFilter === 'guest' },
                )}
              >
                여행자
                <div className="text-gray-500 text-xs mt-1">
      ...
      <div className="grow basis-0 hidden md:flex gap-4 align-middle justify-end relative">
        ...
        <button
          ...
          className="flex align-middle gap-3 rounded-full border 
          border-gray-20 shadow-sm px-4 py-3 my-auto hover:shadow-lg"
        >
          <AiOutlineMenu />
          <AiOutlineUser />
        </button>
