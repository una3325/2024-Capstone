  ...
  return (
    <footer className="bg-gray-50 py-2">
      ...
      <div className="text-[10px] text-gray-400 mx-auto p-4 max-w-screen-xl">
        웹사이트 제공자 : HPNY | 웹사이트 | 호스팅 서비스 제공업체 : vercel |
        HPNY_Comma Comma 플랫폼을 통하여 예약된 숙소, 체험, 호스트 서비스에 관한
...
// 사업자 등록 번호 : 없음 | 연락처 :
//         comma@mail.com, 는 통신판매 중개자로 Comma 플랫폼을 통하여 게스트와 호스트 사이에
//         이루어지는 통신판매의 당사자가 아닙니다.
